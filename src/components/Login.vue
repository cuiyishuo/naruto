  ...
  <div class="login_container">
    ...
    <div class="login_box">
      ...
      <div class="avatar_box">
        <!-- 跳转到注册页面 -->
        <router-link to="/register"><img src="../assets/login/avatar.png" alt="注册"/></router-link>
      </div>
      <!-- 图片内文字 -->
      ...
      <!-- 通过ref属性，拿到表单的实例对象 -->
      <el-form class="login_form_box" :model="loginForm" :rules="loginFormRules" ref="loginFormRef">
        <!-- 用户名 -->
